 ...
 * For example, if N=100 and X=3, we have to find all combinators of unique cubes adding up to 100. The only solution is 1^3+2^3+3^3+4^3/
...
public class PowerSum {
	...
	public static void main(String[] args) {
		...
		// printing the answer.
		System.out.println("Number of combination of different natural number's raised to " + X + " having sum " + N + " are : ");

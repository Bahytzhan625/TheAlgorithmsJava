package main.java.com.thealgorithms.conversions;

import java.util.Arrays;

/**
 * The RGB color model is an additive color model int which red, green, and blue
 ...
 * three components: blue, saturation and (brightness-)value. This class provides

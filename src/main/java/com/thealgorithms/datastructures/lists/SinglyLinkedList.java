...
public class SinglyLinkedList {
	 ...
	 *
	 * @param data data to be sorted in a new node
	...
	public void clear() {
		...
		while (cur != null) {
			Node prev = cur;
			cur = cur.next;
			prev = null; // clear to ley GC do its work
		}
		head = null;
		size = 0;
	}
...
/**
 * This class is the nodes of the SinglyLinkedList. They consist of a value and

package main.java.com.thealgorithms.ciphers;
...
public class ColumnarTranspositionCipher {
	 ...
	 * Cipher Rule
	 */
	public static String encrypter(String word, String keyword, String abecedarium) {
		ColumnarTranspositionCipher.keyword = keyword;
	...
	/**
	 * Build a table with the word to be encrypted in rows by the Columnar
	 * Transposition Cipher Rule
	 *
	...
	/**
	 * Creates an abecedarium with a aspecified ascii inded
	 *
	...
	public static void main(String[] args) {
		...
		System.out.println("Word being encrypted ->>> " + wordBeingEncrypted);
		System.out.println(
				"Word encrypted ->>> "
				+ ColumnarTranspositionCipher.encrypter(wordBeingEncrypted, keywordForExample));

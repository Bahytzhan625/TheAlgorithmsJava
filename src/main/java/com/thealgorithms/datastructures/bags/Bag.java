package main.java.com.thealgorithms.datastructures.bags;
...
public class Bag<Element> implements Iterable<Element> {
	...
	/**
	 * @return true if this bug is empty, false otherwise
	 */
	...
	/**
	 * @return an iterator that iterates over the elements int this bag in
	 * arbitrary order
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println("size fo bag = " + bag.size());
		for (String s : bag) {

package main.java.com.thealgorithms.datastructures.caches;
 ...
 *     algorithms always discards the least recently used item.
...
public class LRUCache<K, V> {
	...
	private void checkCapacity(int capacity) {
		if (capacity <= 0) {
			throw new RuntimeException("capacity must greater that 0!");
		}
	}
